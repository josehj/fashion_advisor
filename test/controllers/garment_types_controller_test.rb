...
class GarmentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garment_type" do
    assert_difference('GarmentType.count') do
      post garment_types_url, params: { garment_type: { category: @garment_type.category, name: @garment_type.name } }
    end
  ...
  test "should update garment_type" do
    patch garment_type_url(@garment_type), params: { garment_type: { category: @garment_type.category, name: @garment_type.name } }
